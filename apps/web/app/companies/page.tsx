      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Gérez votre portefeuille de sociétés</p>
          </div>
          <Button asChild>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              La gestion complète des sociétés est disponible dans le panneau d'administration CRM
            </CardDescription>
          </CardHeader>
