    ...
    <div className={cn("w-full", className)}>
      ...
      <div
        ...
        className={cn(
          ...
          !isUploading && "cursor-pointer hover:border-primary hover:bg-accent/50",
          ...
          {isUploading ? (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">ou cliquez pour parcourir (Max {Math.floor(maxSize / 1024 / 1024)} Mo)</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
