...
const allActionsSample = [
    {
        id: "1",
        label: fr.command.actions.bookTickets,
    ...
    {
        id: "2",
        label: fr.command.actions.summarize,
    ...
    {
        id: "3",
        label: fr.command.actions.screenStudio,
    ...
    {
        id: "4",
        label: fr.command.actions.talkToJarvis,
    ...
    {
        id: "5",
        label: fr.command.actions.components,
            ...
            <div className="relative flex flex-col justify-start items-center">
                <div className="w-full max-w-sm sticky top-0 z-10 pt-4 pb-1">
                    ...
                    <div className="relative">
                        <Input
                            type="text"
                            placeholder={fr.command.placeholder}
                            value={query}
                            ...
                            id="search"
                            autoComplete="off"
                            className="pl-3 pr-9 py-1.5 h-9 text-sm rounded-lg focus-visible:ring-offset-0 bg-background"
                        />
                ...
                <div className="w-full max-w-sm absolute top-full left-0 z-50">
                    <AnimatePresence>
