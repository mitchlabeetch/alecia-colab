    ...
    command: ({ editor, range }) => {
      editor.chain().focus().deleteRange(range).insertContent([
        ...
        { type: "taskList", content: [
          ...
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Analyze revenue trends and customer concentration" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Evaluate debt structure and obligations" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Review working capital requirements" }] }] },
        ]},
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Legal Due Diligence" }] },
        { type: "taskList", content: [
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Corporate structure and governance" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Material contracts review" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Intellectual property assessment" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Litigation and regulatory compliance" }] }] },
        ]},
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Operational Due Diligence" }] },
        { type: "taskList", content: [
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Operations and supply chain review" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Technology infrastructure assessment" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Human resources and culture evaluation" }] }] },
        ]},
      ]).run();
    },
  },
  {
    ...
    command: ({ editor, range }) => {
      editor.chain().focus().deleteRange(range).insertContent([
        ...
        { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Company: " }, { type: "text", text: "[Target Company Name]" }] },
        { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Valuation Date: " }, { type: "text", text: "[Date]" }] },
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Valuation Methodologies" }] },
        { type: "orderedList", content: [
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "DCF Analysis: " }, { type: "text", text: "$[Amount]" }] }] },
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Comparable Companies: " }, { type: "text", text: "$[Amount]" }] }] },
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Precedent Transactions: " }, { type: "text", text: "$[Amount]" }] }] },
        ]},
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Key Assumptions" }] },
        { type: "bulletList", content: [
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Revenue growth rate: [X]%" }] }] },
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "EBITDA margin: [X]%" }] }] },
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "WACC: [X]%" }] }] },
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Terminal growth rate: [X]%" }] }] },
        ]},
      ]).run();
    },
  },
  {
    ...
    command: ({ editor, range }) => {
      editor.chain().focus().deleteRange(range).insertContent([
        ...
        { type: "taskList", content: [
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Communication to employees and stakeholders" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Establish integration management office (IMO)" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "IT systems access and security" }] }] },
        ]},
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "First 100 Days" }] },
        { type: "taskList", content: [
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Organizational structure alignment" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Systems and process integration" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Quick wins and synergy realization" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "Culture integration initiatives" }] }] },
        ]},
        { type: "heading", attrs: { level: 3 }, content: [{ type: "text", text: "Expected Synergies" }] },
        { type: "bulletList", content: [
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Cost synergies: $[Amount]" }] }] },
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Revenue synergies: $[Amount]" }] }] },
          { type: "listItem", content: [{ type: "paragraph", content: [{ type: "text", text: "Timeline to achieve: [X] months" }] }] },
        ]},
      ]).run();
    },
  },
  {
    ...
    command: ({ editor, range }) => {
      editor.chain().focus().deleteRange(range).insertContent([
        ...
        { type: "paragraph", content: [{ type: "text", text: "[Brief description of the business, products/services, and market position]" }] },
  ...
  },
  {
    ...
    command: ({ editor, range }) => {
      editor.chain().focus().deleteRange(range).insertContent([
        ...
        { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Topic: " }, { type: "text", text: "[Subject]" }] },
        ...
        { type: "taskList", content: [
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "[Action 1] - [Owner] - [Due Date]" }] }] },
          { type: "taskItem", attrs: { checked: false }, content: [{ type: "paragraph", content: [{ type: "text", text: "[Action 2] - [Owner] - [Due Date]" }] }] },
        ]},
      ]).run();
    },
  },
