...
/**
 * Loader - Composant de chargement élégant avec animations Motion
...
export default function Loader({
  ...
  subtitle = "Veuillez patienter pendant la préparation",
  size = "md",
  className,
  ...props
}: LoaderProps) {
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center gap-8 p-8", className)} {...props}>
      ...
      {/* Typographie avec animation de respiration */}
      <motion.div
